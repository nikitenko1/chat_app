...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!userData.name)
      return dispatch({
        type: 'alert/alert',
        payload: { errors: 'Please provide name field.' },
      });
  ...
  return (
    <>
      <HeadInfo title="Let's work | Sign Up" />
      <div className="flex">
        <div className="p-9 flex-1">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mt-10">
              ...
              <Link
                to="/login"
                className="bg-gray-100 w-24 block h-10 text-center leading-10 rounded-full hover:bg-gray-200 transition-[background]"
              >
                Login
              </Link>
            </div>
